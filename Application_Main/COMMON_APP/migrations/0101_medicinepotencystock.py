# Generated by Django 4.2.3 on 2023-10-28 21:01
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("COMMON_APP", "0100_medicinesvendordetails"),
    ]

    operations = [
        migrations.CreateModel(
            name="MedicinePotencyStock",
            fields=[
                (
                    "id",
                    models.BigAutoField(
