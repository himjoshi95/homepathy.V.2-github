...
urlpatterns = [
    ...
    path('update-present-complaints-pad/<int:pk>/',update_present_complaints_pad,name='update_present_complaints_pad'),
    ...
    path('delete-present-complaints-pad/<int:pk>/',delete_present_complaints_pad,name='delete_present_complaints_pad'),
